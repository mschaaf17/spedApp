...
async function seedAccommodations() {
  try {
    ...
    const accommodationCards = await AccommodationCards.create(
      accommodationCardSeeds.map((seed) => ({
        ...seed,
...
async function seedStudentAccommodations(accommodations) {
  try {
    ...
    for (const studentAccommodation of studentAccommodationsSeed) {
      ...
      const studentAccommodations = studentAccommodation.accommodations.map(
        (title) => {
